...
public class PullToRefreshView extends LinearLayout {
    ...
    private OnScrollButtomListener mOnScroolbuttom;
    private boolean scroolEndber = false;
    private boolean footEndber = true;
    private boolean headEndber = true;
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.pull_to_refresh_head, this,
                false);
    ...
    private void addFooterView() {
        ...
        // 鐢变簬鏄嚎鎬у竷灞�彲浠ョ洿鎺ユ坊鍔�鍙AdapterView鐨勯珮搴︽槸MATCH_PARENT,閭ｄ箞footer
        // view灏变細琚坊鍔犲埌鏈�悗,骞堕殣钘�
    ...
    /**
     * init AdapterView like ListView,GridView and so on;or init ScrollView iniy
     * WebView
     *
    ...
    public void setScrolEndber(boolean fags) {
        scroolEndber = fags;
    }

    public void setFootEndber(boolean fags) {
        this.footEndber = fags;
    }

    public void setHeadEndber(boolean fags) {
        this.headEndber = fags;
    }
     ...
     *
     * @param deltaY , deltaY > 0 鏄悜涓嬭繍鍔�< 0鏄悜涓婅繍鍔�
     * @return
     */
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if (mScrollView != null) {
            ...
            if (mOnScroolbuttom != null) {
                View child = mScrollView.getChildAt(0);
                if (deltaY > 0 && mScrollView.getScrollY() == 0) {
                    mPullState = PULL_DOWN_STATE;
                    return true;
                } else if (deltaY < 0
                        && child.getMeasuredHeight() - 20 <= getHeight()
                        + mScrollView.getScrollY()) {
                    mOnScroolbuttom.onScrollbutton();
                    mPullState = PULL_UP_STATE;
                    return true;
                }
            } else {
    ...
    public void headerRefreshing() {
        ...
        mHeaderTextView.setText(R.string.pushmsg_center_load_more_ongoing_text);
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView
                .setImageResource(R.mipmap.zebra_ic_list_view_pull_arrow);
        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
        mHeaderProgressBar.setVisibility(View.GONE);
        mHeaderUpdateTextView.setText("更新于:"
    ...
    public void onHeaderRefreshComplete1() {
        setHeaderTopMargin(-mHeaderViewHeight);
        // mFooterView.setVisibility(View.GONE);
        mHeaderImageView.setVisibility(View.VISIBLE);
        mHeaderImageView
     ...
     *
     * @param topMargin 锛屼负0鏃讹紝璇存槑header view
     *                  鍒氬ソ瀹屽叏鏄剧ず鍑烘潵锛�涓�mHeaderViewHeight鏃讹紝璇存槑瀹屽叏闅愯棌浜� hylin
     *                  2012-7-31涓婂崍11:24:06
     * @description
     */
     ...
     *
     * @param headerRefreshListener hylin 2012-7-31涓婂崍11:43:58
     * @description
     */
    ...
    public void setOnScrollButtomListener(OnScrollButtomListener lsn) {
        mOnScroolbuttom = lsn;
    }

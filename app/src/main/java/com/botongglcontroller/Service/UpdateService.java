...
public class UpdateService extends Service {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DOWN_OK:
                    ...
                    notification2.icon = R.mipmap.notice;
    ...
    public void createNotification() {
        ...
        notification.icon = R.mipmap.notice;
...
//		contentView.setImageViewResource(R.id.notificationImage, R.mipmap.notice);

...
public class OneNetApi {
    ...
    public static void queryMulDevice(Map<String, String> params, OneNetApiCallback callback) {
        get(Device.urlForQueryingMul(params), callback);
    }
    ...
    public static void sendCmdToDevice(String deviceId, boolean needResponse, int timeout,
                                       Command.CommandType type, byte[] by,
                                       OneNetApiCallback callback) {
        post(Command.urlForSending(deviceId, needResponse, timeout, type), by, callback);
    }

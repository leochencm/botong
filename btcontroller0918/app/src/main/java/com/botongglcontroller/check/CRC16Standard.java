...
public class CRC16Standard {
    ...
    public static String DoCRCIBM(String num){

        byte[] crc = CRC16Standard.getCRCBytes(Bytes. HexString2Bytes(Bytes.stringToHexString(num)));
        System.out.println(Bytes.Bytes2HexString(crc));

        return Bytes.Bytes2HexString(crc);
    }

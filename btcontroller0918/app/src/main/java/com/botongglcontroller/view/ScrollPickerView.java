...
import com.botongglcontroller.interfaces.IPickerViewOperation;
import com.botongglcontroller.utils.ScreenUtil;
    ...
    private void measureSize() {
        if (getChildCount() > 0) {
            ...
            if (mItemWidth == 0) {
                ...
                mItemWidth = vg.getWidth();//getChildAt(0).getMeasuredWidth();
            }
